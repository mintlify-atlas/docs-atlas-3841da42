...
<Steps>
  ...
  <Step title="Link to it from Navigation">
    Add a new entry to the links array in `src/components/Navigation.tsx` so users can reach the new page. See [Navigation](/components/navigation) for the exact pattern.
  </Step>
</Steps>
